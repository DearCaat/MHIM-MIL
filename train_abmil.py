...
from modules import attmil,clam,contrastive1,dsmil,transmil,mean_max
# try:
...
def one_fold(args,k,ckc_metric,train_p, train_l, test_p, test_l,val_p,val_l):
    ...
    if args.model == 'mhim':
        ...
        model = contrastive1.CLR(mask_ratio=args.mask_ratio,n_classes=args.n_classes,mfm_enable=False,act=args.act,attn=args.attn,region_num=args.region_num,head=args.n_heads,da_act=args.da_act,baseline=args.baseline).to(device)
